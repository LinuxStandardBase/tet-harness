...
LSB_TET_SOURCE_NAME=$(LSB_FULL_PACKAGE_NAME)-$(RELEASE).src.rpm
LSB_TET_BINARY_NAME=$(LSB_FULL_PACKAGE_NAME)-$(RELEASE).$(RPM_BUILD_ARCH).rpm
LSB_TET_DEVEL_BINARY_NAME=$(LSB_PACKAGE)-devel-$(VERSION)-$(RELEASE).$(RPM_BUILD_ARCH).rpm
